...
if st.session_state.page == "home":
    ...
    if st.button("🚀 Write My Story", type="primary"):
        if w1 and w2 and w3:
            # Note: We don't need to manually save inputs to session_state anymore
            # because the widget keys ("w1", "w2", "w3") store them automatically.
...
# ==========================================
    ...
    if st.session_state.should_generate:
        try:
            ...
            # Max 50 words prompt
            prompt = (
                f"Write an ultra-short, funny story (max 50 words) for kids using: {word1}, {word2}, {word3}. "
